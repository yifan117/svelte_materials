...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-b1a50b8b.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-b1a50b8b.js", "_app/immutable/chunks/index-2b05990c.js"];
...
<body class="${"svelte-3av19o"}"><div class="${"cards-container svelte-3av19o"}"><a href="${"https://kit.svelte.dev/"}" target="${"_blank"}" class="${"card svelte-3av19o"}"><div class="${"card-background svelte-3av19o"}" style="${"background-image: url(https://miro.medium.com/max/875/1*jk1lk3q-vFzT45_ucP75Yg.png); background-color: #ffffff"}"></div>
    ...
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"page"}">${validate_component(Materialv2, "Materialv2").$$render($$result, {}, {}, {})}
...
function serialize_data(fetched) {
